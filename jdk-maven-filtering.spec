...
#
Name     : jdk-maven-filtering
Version  : 3.1.1
Release  : 1
URL      : http://repo1.maven.org/maven2/org/apache/maven/shared/maven-filtering/3.1.1/maven-filtering-3.1.1-source-release.zip
Source0  : http://repo1.maven.org/maven2/org/apache/maven/shared/maven-filtering/3.1.1/maven-filtering-3.1.1-source-release.zip
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-maven-filtering-data
...
%package data
Summary: data components for the jdk-maven-filtering package.
Group: Data

%description data
data components for the jdk-maven-filtering package.


%prep
%setup -q -n maven-filtering-3.1.1

%build
python3 /usr/share/java-utils/mvn_build.py -f

%install
xmvn-install  -R .xmvn-reactor -n maven-filtering -d %{buildroot}
...
%files data
%defattr(-,root,root,-)
/usr/share/java/maven-filtering/maven-filtering.jar
/usr/share/maven-metadata/maven-filtering.xml
/usr/share/maven-poms/maven-filtering/maven-filtering.pom
